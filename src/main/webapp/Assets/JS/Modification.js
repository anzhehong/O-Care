...
$('.ChangePhoneNum_form .phoneNum_submit').click(function(e){
    e.preventDefault();
    $.ajax({
        url:'http://localhost:8080/OCare/app/personInforModifyHandle1',
        type:'post',
        async:false,
        data:{
...
$('.ChangePassword_form .password_submit').on('click',function(e){
    e.preventDefault();
    $.ajax({
        url:'http://localhost:8080/OCare/app/personInforModifyHandle2',
        type:'post',
        async:false,
        data:{
...
$('.ChangePicture_form .picture_submit').click(function(e){
    e.preventDefault();
    $.ajax({
        url:'http://localhost:8080/OCare/app/personInforModifyHandle3',
        type:'post',
        async:false,
        data:{
            change:$('#doc1').val()
