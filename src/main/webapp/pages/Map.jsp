    ...
    function RefreshCondition() {
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data[0].json_item_number; i++) {
                    //alert(data[i].elder_status);
                    //获取点
                    var p = new BMap.Point(data[i].latitude, data[i].longtitude);
                    //定义一个表示点的实际地址的变量
                    var adress = "暂时无法获得";
                    //将点加入点集
                    new_points.push(p);
                    ...
                    var info = new BMap.InfoWindow("<div style='width: 320px'><h4 style='margin:0 0 5px 0;padding:0.2em 0'>---</h4>" +
                            ...
                            "<p style='margin:0;line-height:1.5;font-size:13px'>老人状态:<span>" + data[i].elder_status + "</span></p>" +
